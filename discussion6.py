    ...
    def load_results(self, table):
        ...
        for row in table[1:]:
            ...
            for i in range(1, len(row)):
                ...
                horse_data[race_name] = race_time
            
            res_dict[horse_name] = horse_data
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict.keys():
            best_info = self.horse_fastest_race(horse)
            personal_bests[horse] = best_info
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        for horse, races_dict in self.race_dict.items():
            times = races_dict.values()
